...
class LanguageManager {
    ...
    public function loadLang() {
        ...
        foreach (glob(Settings::getDataFolder() . "/languages/*.yml") as $langResource) {
    ...
    public static function getMsg(CommandSender $sender, string $msg, array $params = []): string {
        try {
            ...
            GreekNetwork::getInstance()->getLogger()->error("LanguageManager error: " . $exception->getMessage() . " Try remove language resources and restart the server.");
            return "";
        }
