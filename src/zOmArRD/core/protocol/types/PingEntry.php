...
class PingEntry
{
     ...
     * @param GreekProxyFuture $future
     * @param int $timeout
     */
    public function __construct(GreekProxyFuture $future, int $timeout)
    {
        $this->future = $future;
     ...
     */
    public function getFuture(): GreekProxyFuture
    {
        return $this->future;
    }
